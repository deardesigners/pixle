    ...
    <div className="min-h-screen">
      ...
      <main className="p-6 max-w-5xl mx-auto grid gap-6 md:grid-cols-2">
        ...
        <section className="flex flex-col gap-4">
          ...
          <p className="text-muted leading-relaxed">
            {styleLabel} is one of six render styles available in Pixle. Draw any pixel art
            and instantly see it extruded as a 3D model — no modeling software, no setup. Pick
            from Voxel, Plush, Crystal, Neon, Origami, and Mercury to give your sprite a
            different material and feel.
          </p>
