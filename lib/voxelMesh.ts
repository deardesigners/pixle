 ...
 *
 * Используется для Mercury — вместо рендера N инстансов сфер отдаётся
 * один меш на каждый цвет, по которому можно применить сильный материал
 * (metalness + envmap для отражений жидкого металла).
 */
